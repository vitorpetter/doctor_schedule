...
export const doctorsTable = pgTable("doctors", {
    ...
    availableFromTime: time("available_from_time").notNull(), // e.g. "09:00"
    availableToTime: time("available_to_time").notNull(), // e.g. "17:00"
...
export const appointmentsTable = pgTable("appointments", {
    id: uuid("id").defaultRandom().primaryKey(),
    date: timestamp("appointment_date").notNull(), // e.g. "2023-10-01 10:00:00"
    clinicId: uuid("clinic_id").notNull().references(() => clinicsTable.id, {onDelete: "cascade"}),	
